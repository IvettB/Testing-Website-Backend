...
The API uses Google Authentication to login the user. When the user requests the ```/api/v1/auth/google``` endpoint, they are redirected to a Google login page to enter their name and email, and become and authenticated user. 
